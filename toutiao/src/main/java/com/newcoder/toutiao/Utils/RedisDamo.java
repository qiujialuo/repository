 ...
 */
public class RedisDamo {
    public static void print(int num,Object object){
        System.out.println(String.format("%d:%s",num,object));
    }
    ...
    public static void main(String[] args) {
        ...
        print(28, jedis.smembers(likeKey1));//打印集合中的元素
        print(29, jedis.scard(likeKey1));//打印集合中的元素个数
